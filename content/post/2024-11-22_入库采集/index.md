...
![](http://42.193.239.83/_project/GIF%2011-23-2024%2010-54-35%20AM.gif)

## 1.2 PDA手工操作软件

![](http://42.193.239.83/_project/9A6DA728-D2EB-4941-91E9-AF868ABC16C4.png)
...
```
$ bflat build -Os --stdlib:zero -i gdi32 -i user32 --ldflags C:\Progra~2\WI3CF2~1\10\Lib\10.0
```
...
```
C:\Users\michals\AppData\Local\Microsoft\WinGet\Packages\MichalStrehovsky.bflat_Microsoft.Winget.Source_8wekyb3d8bbwe\bin\lld.exe -flavor link "D:\g
```
